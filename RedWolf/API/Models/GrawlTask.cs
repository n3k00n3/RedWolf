...
namespace RedWolf.API.Models
{
    ...
    public partial class GrawlTask
    {
        /// <summary>
        /// Initializes a new instance of the GrawlTask class.
        /// </summary>
        public GrawlTask()
        {
            CustomInit();
        ...
        public GrawlTask(string name, int? id = default(int?), int? authorId = default(int?), GrawlTaskAuthor author = default(GrawlTaskAuthor), IList<string> aliases = default(IList<string>), string description = default(string), string help = default(string), ImplantLanguage? language = default(ImplantLanguage?), IList<DotNetVersion?> compatibleDotNetVersions = default(IList<DotNetVersion?>), string code = default(string), bool? compiled = default(bool?), GrawlTaskingType? taskingType = default(GrawlTaskingType?), IList<ReferenceSourceLibrary> referenceSourceLibraries = default(IList<ReferenceSourceLibrary>), IList<ReferenceAssembly> referenceAssemblies = default(IList<ReferenceAssembly>), IList<EmbeddedResource> embeddedResources = default(IList<EmbeddedResource>), bool? unsafeCompile = default(bool?), bool? tokenTask = default(bool?), IList<GrawlTaskOption> options = default(IList<GrawlTaskOption>))
        {
            Id = id;
            AuthorId = authorId;
            Author = author;
        ...
        public GrawlTaskAuthor Author { get; set; }
        ...
        public GrawlTaskingType? TaskingType { get; set; }
        ...
        public IList<GrawlTaskOption> Options { get; set; }
