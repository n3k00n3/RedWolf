...
namespace RedWolf.Models.Grawls
{
    public class ReferenceAssembly : ISerializable<ReferenceAssembly>
    {
        ...
        [NotMapped, JsonIgnore, System.Text.Json.Serialization.JsonIgnore]
        public List<GrawlTask> GrawlTasks => GrawlTaskReferenceAssemblies.Select(e => e.GrawlTask).ToList();
    ...
    public class EmbeddedResource : ISerializable<EmbeddedResource>
    {
        ...
        [NotMapped, JsonIgnore, System.Text.Json.Serialization.JsonIgnore]
        public List<GrawlTask> GrawlTasks => GrawlTaskEmbeddedResources.Select(e => e.GrawlTask).ToList();
    ...
    public class ReferenceSourceLibrary : ISerializable<ReferenceSourceLibrary>
    {
        ...
        [NotMapped, JsonIgnore, System.Text.Json.Serialization.JsonIgnore]
        public List<GrawlTask> GrawlTasks => GrawlTaskReferenceSourceLibraries.Select(e => e.GrawlTask).ToList();
    ...
    public class GrawlTaskReferenceSourceLibrary
    {
    ...
    public class GrawlTaskReferenceAssembly
    {
        public int GrawlTaskId { get; set; }
        public GrawlTask GrawlTask { get; set; }
    ...
    public class GrawlTaskEmbeddedResource
    {
        public int GrawlTaskId { get; set; }
        public GrawlTask GrawlTask { get; set; }
