...
namespace RedWolf.Models.Grawls
{
    ...
    public class ImplantTemplate
    {
        ...
        public List<Grawl> Grawls { get; set; } = new List<Grawl>();
        ...
        private string StagerLocation
        {
            get
            {
                ...
                string dir = Common.RedWolfDataDirectory + "Grawl" + Path.DirectorySeparatorChar + Utilities.GetSanitizedFilename(this.Name) + Path.DirectorySeparatorChar;
