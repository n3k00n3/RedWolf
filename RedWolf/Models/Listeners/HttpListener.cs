...
namespace RedWolf.Models.Listeners
{
    ...
    public class HttpListener : Listener
    {
        ...
        public string SSLCertificatePassword { get; set; } = "RedWolfDev";
        ...
        public override CancellationTokenSource Start()
        {
            ...
            using (var scope = host.Services.CreateScope())
            {
                ...
                _ = internalListener.Configure(InternalListener.ToProfile(this.Profile), this.ANOTHERID, configuration["RedWolfUrl"], configuration["RedWolfToken"]);
            }
        ...
        private IHost BuildHost()
        {
            ...
            return new HostBuilder()
                .ConfigureWebHost(webconfig =>
                {
                    ...
                    .UseSetting("RedWolfUrl", this.RedWolfUrl)
                    .UseSetting("RedWolfToken", this.RedWolfToken)
        ...
        public HostedFile HostFile(HostedFile hostFileRequest)
        {
            ...
            if (!FullPath.StartsWith(this.ListenerStaticHostDirectory, StringComparison.OrdinalIgnoreCase)) { throw new RedWolfDirectoryTraversalException(); }
