    ...
    public class Launcher
    {
        ...
        public string Base64ILByteString
        {
            get
            {
                try
                {
                    return Convert.ToBase64String(System.IO.File.ReadAllBytes(Common.RedWolfLauncherDirectory + Name));
                }
                catch
                {
                    return "";
            ...
            set
            {
                System.IO.File.WriteAllBytes(Common.RedWolfLauncherDirectory + Name, Convert.FromBase64String(value)); 
            }
        }
