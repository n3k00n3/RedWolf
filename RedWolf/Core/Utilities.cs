...
namespace RedWolf.Core
{
    public static class Utilities
    {
                                              ...
                                              string JwtKey, string JwtIssuer, string JwtAudience, string JwtExpireDays)
        {
            ...
            SymmetricSecurityKey key = new SymmetricSecurityKey(Common.RedWolfEncoding.GetBytes(JwtKey));
        ...
        public static string GetExtensionForLanguage(Models.Grawls.ImplantLanguage language)
        {
            switch (language)
            {
                case Models.Grawls.ImplantLanguage.CSharp:
                    return ".cs";
                default:
                    return ".cs";
            }
